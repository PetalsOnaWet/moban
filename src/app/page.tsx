    ...
    <div className="animate-fade-in" style={{ padding: '16px' }}>
      ...
      <div style={{
        ...
        {games.map((game, index) => {
          ...
          // We use a modular approach to create a predictable yet organic feel
          let spanClass = { gridColumn: 'span 1', gridRow: 'span 1' };
          
          const position = index % 12; // Pattern repeats every 12 items for consistency
          
          if (position === 0 || position === 11) {
             spanClass = { gridColumn: 'span 2', gridRow: 'span 2' }; // Featured Big Square
          } else if (position === 3 || position === 8) {
             spanClass = { gridColumn: 'span 2', gridRow: 'span 1' }; // Wide Highlight
          } else if (position === 5) {
             spanClass = { gridColumn: 'span 1', gridRow: 'span 2' }; // Tall Highlight
          }
